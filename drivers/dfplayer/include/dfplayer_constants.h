...
#define DFPLAYER_CMD_TRACK_USB      (0x4b)  /**< Get the currently select track on the USB storage */
#define DFPLAYER_CMD_TRACK_SDCARD   (0x4c)  /**< Get the currently select track on the SD-Card */
#define DFPLAYER_CMD_TRACK_FLASH    (0x4d)  /**< Get the currently select track on the NOR flash */
/** @} */
 ...
 */
#define DFPLAYER_FLAG_TIMEDOUT      (0x01)  /**< The ACK of the last command has timed out */
/**
 ...
 * this flag is set
 */
#define DFPLAYER_FLAG_NO_ACK_BUG    (0x02)
#define DFPLAYER_FLAG_FOLDER_FILE   (0x80)  /**< Currently folder/file naming convention is used */
/** @} */
...
#define DFPLAYER_LOWSET_QUERY       (0x40)  /**< Query commands are 0x40 or higher */
