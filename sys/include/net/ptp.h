...
/**
 * @name    Variables to access the current state of the PTP client
 * @{
 */
/**
 * @brief   The estimated round trip network delay
 *
...
/**
 * @brief   The current offset to UTC time in seconds
 *
 ...
 */
extern uint8_t ptp_local_clock_id[8];
/**
 * @brief   The clock ID of the server
 */
extern uint8_t ptp_server_clock_id[8];
/** @} */
